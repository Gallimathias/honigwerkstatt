    ...
    this.landingTextBlockModels = [
      {
        ...
        text: 'Die Imkerei wurde 2014 von mir gegründet. Nach dem interessanten Einführungstag in Hohenheim und einem spannenden Jungimkurs beim BV Nagold ging es los. Hier wurden uns viele Neuigkeiten und die Arbeiten im Bienenjahr in Praxis und Theorie gezeigt und die ersten beiden Völker wurden angeschafft.',
      },
      {
        title: 'die Biene',
